...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s samplecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  samplecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded samplecoin transaction") + "\n" +
              "  samplecoin-tx [options] -create [commands]   " + _("Create hex-encoded samplecoin transaction") + "\n" +
              "\n";
