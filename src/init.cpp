...
{
    const std::string URL_SOURCE_CODE = "<https://git.cryptogera.com/cryptogera/samplecoin>";
    const std::string URL_WEBSITE = "<https://cryptogera.com>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("SampleCoin version %s\n", FormatFullVersion());
}
